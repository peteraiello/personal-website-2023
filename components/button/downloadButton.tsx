...
export const DownloadButton = ({
    ...
    return (
        <div className="flex gap-3">
            <a href={downloadLink} className="group text-brandBlue dark:text-brandGold bg-transparent text-[24px] tracking-normal uppercase font-bold ring-1 border-brandBlue dark:ring-white rounded-[20px] px-10 py-3 hover:dark:ring-brandGold hover:dark:bg-brandGold hover:dark:text-darkGray transition-all duration-150 ease-in-out">
                ...
                <path 
                    className="fill-brandBlue dark:fill-brandGold group-hover:dark:fill-darkGray"
